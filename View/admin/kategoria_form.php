...
<body>    
    ...
    <main class="container-fluid">
        <div class="row">            
            <? $active = empty($category['id']) ? 'Új kategória' : ''; include_once('menu.php'); ?>
            <div class="col-5 offset-3">
                <?= $object->msg->messages() ?>
                <?= $object->msg->getSessionMessage() ?>
                <h3 class="mx-2 text-center"><?= empty($category['id']) ? 'Új kategória' : 'Kategória módosítása' ?></h3>
                <form method="post" class="container-fluid" id="ujkategoria_form">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-10"><input type="text" class="form-control" name="name" value='<?= empty($category['name']) ? '' : $category['name'] ?>'></div>
                            </div>
                        </div>                            

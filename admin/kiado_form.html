    ...
    <main class="container-fluid">
        <div class="row">
            <div class="col-2" id="navigacio">
                ...
                <nav class="navbar pt-0">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item text-end">
                            <a class="nav-link active" href="kiado_form.html">Új kiadó</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="col-5 offset-3">
                <h3 class="mx-2 text-center">Új kiadó</h3>
                <form action="action_page" method="post" class="container-fluid" id="ujkiado_form">
                    <div class="row">
                        <div class="col-12">
                            <div class="row">

    ...
    <main class="container-fluid">
        <div class="row">
                ...
                <nav class="navbar pt-0">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item text-end">
                            <a class="nav-link active" href="kategoria_form.html">Új kategória</a>
                        </li>
                        <li class="nav-item text-end">
            ...
            <div class="col-5 offset-3">
                <h3 class="mx-2 text-center">Új kategória</h3>
                <form action="action_page" method="post" class="container-fluid" id="ujkategoria_form">
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                        ...
                        <div class="col-5 mt-2">
                            ...
                            <button type="reset" name="reset" id="reset" class="btn btn-danger my-2" onclick="location.href='listak.html'">Mégse</button>
                        </div>
                    </div>
                </form>
            </div>
